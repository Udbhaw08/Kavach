...
async def run():
    ...
    await drone.param.set_param_float("MPC_TILTMAX_AIR", 60.0)  # allow aggressive pitch
    ...
    # ======================================================
    # 3️⃣ PRE-DIVE FORWARD LOCK (CRITICAL FIX)
    # ======================================================
    ...
    # ======================================================
    # 4️⃣ TRUE DIVE (NO VERTICAL DROP)
    # ======================================================
    print("TRUE DIVE INITIATED")
    log = []
